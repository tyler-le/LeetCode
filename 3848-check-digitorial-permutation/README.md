<h2><a href="https://leetcode.com/problems/check-digitorial-permutation">4226. Check Digitorial Permutation</a></h2><h3>Medium</h3><hr><p>You are given an integer <code>n</code>.</p>
