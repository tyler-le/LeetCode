...
<pre style="position: relative;"><strong>Input:</strong> products = ["mobile","mouse","moneypot","monitor","mousepad"], searchWord = "mouse"
...
<pre style="position: relative;"><strong>Input:</strong> products = ["havana"], searchWord = "havana"
